...
- Accuracy: 80%
- Kappa: 0.75
- Lift на редких классах (G3): 12.0

## 🔍 Ключевая фишка: Profit Curve

Большинство аналитиков оценивают модели по Accuracy/F1. Я иду дальше — строю **Profit Curve** с учётом стоимости ошибок:
...
├── data/
│   └── glass.csv          ← Исходные данные (скачать с Kaggle)
└── output/
