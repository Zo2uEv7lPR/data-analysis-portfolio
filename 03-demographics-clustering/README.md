...
Анимация переходов в отчёте закомментирована по умолчанию: рендеринг ~114 кадров занимает **10–15 минут**. Раскомментируйте соответствующий chunk, если хотите пересобрать `cluster_transitions.gif`.
